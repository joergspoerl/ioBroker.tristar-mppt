...
exports.TristarMpptCon = void 0;
/* eslint-disable @typescript-eslint/no-var-requires */
// create a tcp modbus client
const modbus = require("jsmodbus");
const net = require("net");
class TristarMpptCon {
    constructor() {
        this.hostname = "";
        this.unitId = 1;
        this.tristarHoldingRegister = {};
    }
    // constructor(tristar_address: string) {
    // 	this.tristar_address = tristar_address
    // }
    async connectAndRequest(hostname) {
        return new Promise((resolve, reject) => {
            ...
            netSocket.on("connect", function () {
                ...
                client.readHoldingRegisters(0, 80).then(function (tristarHoldingRegister) {
                    ...
                    const hr = { register: tristarHoldingRegister.response._body.valuesAsArray };
...
exports.TristarMpptCon = TristarMpptCon;
//# sourceMappingURL=tristarMpptCon.js.map